...
fn plan_item_token(it: crate::answer_plan::AnswerPlanItemKindV1) -> (MarkovChoiceKindV1, &'static [u8]) {
    match it {
        crate::answer_plan::AnswerPlanItemKindV1::Summary => (MarkovChoiceKindV1::Opener, b"plan_item:summary"),
        crate::answer_plan::AnswerPlanItemKindV1::Bullet => (MarkovChoiceKindV1::Transition, b"plan_item:bullet"),
        crate::answer_plan::AnswerPlanItemKindV1::Step => (MarkovChoiceKindV1::Transition, b"plan_item:step"),
        crate::answer_plan::AnswerPlanItemKindV1::Caveat => (MarkovChoiceKindV1::Closer, b"plan_item:caveat"),
    }
}
