...
#[test]
fn puzzle_free_text_triggers_conversational_clarify() {
    let base = tmp_dir("puzzle_free_text_triggers_conversational_clarify");
    ...
    // Free-text puzzle-style prompt: should produce a conversational clarifying question,
    // not require a structured block.
